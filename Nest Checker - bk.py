...
homedir = r'Z:\Laser NC Codes\Nest Checker'
#homedir = r'C:\Users\mcolin\Desktop\Nest Checker'
tasksdir = r'Z:\Laser NC Codes\LP\(0000) MetaCAM Report'
...
while True:
	...
	#				print('Could not process folder: ' + task + '\n Please rename with job numbers.')
			...
			#	pickle.dump(nlog, log_file, protocol=pickle.HIGHEST_PROTOCOL)
	...
	#	time.sleep(300)
		...
		print(exception)
		ctypes.windll.user32.MessageBoxW(0, exception, "Error", 1)
		input("Press Enter to continue...")